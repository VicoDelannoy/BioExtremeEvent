...
```{r}
baseline_qt90 <- BEE.calc.baseline(YourSpatraster = ds, start_date = "2009-01-01", end_date = "2010-12-31", threshold = "qt", quantile_value = 0.9, time_window = 5, smooth_window = 7) 
