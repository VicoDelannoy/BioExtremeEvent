...
ds <- rast("Data/ds_Golfe_du_lion.tiff")
```
...
points_metrics <- BEE.calc.metrics_point(Events_corrected, Values = ds, GPS, start_date = "2022-01-01", end_date = "2024-12-31", baseline_qt90 = baseline_qt90, baseline_mean = baseline_mean, group_by_event = FALSE)
...
dist_to_escape <- BEE.calc.escape(true_event_output=result,
                start_date = "2022-04-01", end_date = "2022-08-31", 
                pixel= GPS, 
                only_days_EE = TRUE,
                each_event = FALSE)
