...
points_metrics <- BEE.calc.metrics_point(Events_corrected, Values = ds, GPS, start_date = "2022-01-01", end_date = "2024-12-31", baseline_qt = baseline_qt90, baseline_mean = baseline_mean, group_by_event = TRUE)
...
```{r}
list_morpho_metrics <- BEE.calc.metrics_morpho(Corrected_rasters, start_date = "2024-06-01", end_date = "2024-09-31", per_pix=TRUE) # Give a summary of the metrics of each patch present in the provided area for each days.
