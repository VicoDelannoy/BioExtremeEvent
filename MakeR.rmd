...
```{r}
list_morpho_metrics <- BEE.calc.metrics_morpho(Corrected_rasters, start_date = "2024-05-01", end_date = "2024-11-30", per_pix=FALSE, crs = "EPSG:2154") # Give a summary of the metrics of each patch present in the provided area for each days.
