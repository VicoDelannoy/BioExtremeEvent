...
save(baseline_qt90, file= here::here("Outputs","baseline_qt90.")) 
# Takes a couple of minutes baseline_qt90 <- load(here::here("Outputs/baseline_qt90.RData"))

# Mean Basline 
baseline_mean <- BEE.calc.baseline(rast_name = raster_time_serie, threshold = "mean", quantile_value = NULL)
saveRDS(baseline_mean, file= here::here("Outputs","baseline_mean.RDS"))
```
...
#plot(period_of_interest[[1]]) ; plot(baseline_qt90[[1]]) ; plot(binarized_EE[[1]]["2021-01-01"])
```
