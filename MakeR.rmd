...
df_plot <- data.frame(doy=seq(1:366),
                      qt10=t(terra::extract(baseline_qt10,507)), #608 is frontignant pixel
...
```{r}
GPS <- data.frame(x = c(3.7659, 5.386, 3.146), # Frontignan, îles du Frioul, Banyuls
                  y = c(43.4287, 43.183, 42.781))
points_metrics <- BEE.calc.metrics_point(Events_corrected, Values = ds, GPS, start_date = "2022-01-01", end_date = "2024-12-31")
