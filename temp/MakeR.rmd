...
points_metrics <- BEE.calc.metrics_point(Events_corrected, Values = ds, GPS, start_date = "2024-06-01", end_date = "2024-10-31", baseline_qt = baseline_qt90, baseline_mean = baseline_mean, group_by_event = FALSE)
...
```{r}
list_morpho_metrics <- BEE.calc.metrics_morpho(Corrected_rasters, start_date = "2024-05-01", end_date = "2024-11-30", per_pix=TRUE, crs = "EPSG:2154") # Give the spatial metrics of each patch present in the provided area for each days.
