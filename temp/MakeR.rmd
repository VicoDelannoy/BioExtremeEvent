...
ggplot(df_plot, ggplot2::aes(x = doy)) +
  geom_line(ggplot2::aes(y = mean), color = "darkgreen", size = 1) +  # Ligne verte pour la moyenne
  geom_line(ggplot2::aes(y = qt10), color = "blue4", linetype = "dashed", size = 1) +  # Qt10 en bleu en tirets
  geom_line(ggplot2::aes(y = qt90), color = "red3", linetype = "dashed", size = 1) +  # Qt90 en rouge en tirets
