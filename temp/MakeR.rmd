...
```{r}
# SST
ds <- terra::rast("Data/cmems_SST_MED_SST_L4_REP_OBSERVATIONS_010_021_analysed_sst_2.94E-7.80E_42.01N-43.67N_1982-01-01-2024-12-31.nc")
...
```{r}
baseline_qt90 <- BEE.calc.baseline(YourSpatraster = ds, start_date = "1982-01-01", end_date = "2010-12-31", threshold = "qt", quantile_value = 0.9, time_window = 1, smooth_window = 1) 
...
```{r chunk-5}
binarized_EE <- BEE.calc.binarize(ds, baseline=baseline_qt90, direction = "above") #by default, direction == "above" #16:20
