...
```{r}
list_morpho_metrics <- BEE.calc.metrics_morpho(Corrected_rasters, start_date = "2024-05-01", end_date = "2024-11-30", per_pix=FALSE, crs = "EPSG:2154") # Give the spatial metrics of each patch present in the provided area for each days.

saveRDS(list_morpho_metrics[[1]], file = "Data/list_morpho_metrics_dt.rds")
list_morpho_metrics_dt <- readRDS("Data/list_morpho_metrics_dt.rds")
saveRDS(list_morpho_metrics[[2]], file = "Data/list_morpho_metrics_rasters.rds")
list_morpho_metrics_rasters <- readRDS("Data/list_morpho_metrics_rasters.rds")
list_morpho_metrics <- list(list_morpho_metrics_dt, list_morpho_metrics_rasters)
