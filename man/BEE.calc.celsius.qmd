...
This funciton check that the SpatRasters unit for temperature is Celsius, if not, it does the conversion from kelvin/fahrenheit to celsius or return an error message if the unit is not Celsius or Kelvin or Fahrenheit. It is design for '.nc' files.
