...
This funciton check that the spat rasters unit for temperature is Celsius, if not it does the convertion from kelvin to celsius or return an error message if the unit is not Celsius or Kelvin.
It is design for '.nc' files.

```{r}
EE.calc.Celsius <- function(YourSpatRaster) {
