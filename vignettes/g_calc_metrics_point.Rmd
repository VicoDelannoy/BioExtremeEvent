...
# Usage
## Arguments:
**extreme_event**: Is the list of data tables produced by:
 ...
 **group_by_event**: Whether you want an output summarise by extreme event
 or not. If not, you just get daily metrics.  Use FALSE to be able to use the output in BEE.data.merge().
...
```{r}
 metrics_points_day <- BEE.calc.metrics_point(
  extreme_event = binarized_corrected_df,
