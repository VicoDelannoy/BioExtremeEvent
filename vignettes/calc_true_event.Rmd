...
# Plot a layer
date <- terra::time(binarized_corrected_spatraster[[850]])
terra::plot(binarized_corrected_spatraster[[850]],
            main = as.character(date))
# Here 850 refers to the layers of the spatraster <-> 850th days of the spatraster.
```
