...
# Aims of the function *BEE.id.extreme_days()*
...
# 90th percentile.:
binarized <- BEE.id.extreme_days(YourSpatraster=copernicus_data,
...
binarized_fixed_threshold <- BEE.id.extreme_days(YourSpatraster=copernicus_data,
                                   baseline= 12.5,
                                   direction = "below")
```
