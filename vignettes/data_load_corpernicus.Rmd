...
terra::plot(
  copernicus_data[[1]],
  main = paste("Temperature in the Gulf of Lion on the", terra::time(copernicus_data[[1]]) ),
  xlab = "Longitude (E)",  
  ylab = "Latitude (N)",  
  col = terra::terrain.colors(100),  
  legend.args = list(text = "Kelvin", side = 4, line = 2.5) 
)
```